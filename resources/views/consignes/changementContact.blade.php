            ...
            <div class="col-md-12">
               <div class="card">
                   <div class="card-header">
                         ...
                         <form method="POST" action="{{ route('changement-action', ['client' => $client->id]) }}">
                            @csrf
                            @method("GET")
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <label class="form-control-label" for="form_nouveau_contat">{{__('Nouveau contact')}}</label>
                                            <input type="text" name="nouveau_contact"  required class="form-control" >
                                            @include('alerts.feedback',['field'=>'nouveau_contact'])
                                    </div>
                                        <div class="form-group col-md-6">
